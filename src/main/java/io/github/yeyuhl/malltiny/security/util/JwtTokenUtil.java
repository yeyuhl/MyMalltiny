package io.github.yeyuhl.malltiny.security.util;
...
/**
 * JwtToken生成的工具类
 * JWT token的格式：header.payload.signature（头部.载荷.签证）
 * header的格式（加密算法、token的类型）：
 * {"alg": "HS512","typ": "JWT"}
...
public class JwtTokenUtil {
    ...
    private String generateToken(Map<String, Object> claims) {
        return Jwts.builder()
                ...
                // generate a compact and URL-safe JWT string，生成紧凑token
                .compact();
    }
